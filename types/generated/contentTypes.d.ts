...
export interface ApiActAct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    section6Content: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    section7Content: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section7Title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section8Content: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section8Title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPrivacyPrivacy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::privacy.privacy'
    >;
    privacyPolicyText: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiToxismToxism extends Struct.CollectionTypeSchema {
  collectionName: 'toxisms';
  info: {
    displayName: 'toxism';
    pluralName: 'toxisms';
    singularName: 'toxism';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::toxism.toxism'>;
    publishedAt: Schema.Attribute.DateTime;
    section1Content: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::toxism.toxism': ApiToxismToxism;
